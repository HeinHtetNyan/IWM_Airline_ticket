# IWM Airline Ticket — API Documentation
...
- POST `/api/auth/customer/signup` (201)
  - Body: `CustomerSignupIn` (email, password, full_name, phone)
  - Response: `TokenOut` (access_token, token_type, user)

- POST `/api/auth/customer/login`
  For full example requests and JSON responses see the separate file: [docs/EXAMPLES.md](docs/EXAMPLES.md)
